...
final mockStockScanDataSourceProvider = Provider<StockScanDataSource>(
  (ref) => MockStockScanDataSource(),
);

// Create a mock class for StockScanDataSource
class MockStockScanDataSource implements StockScanDataSource {
  @override
  Future<List<StockScanModel>?> getScans() {
    ...
    return Future.value(scans.map((e) => StockScanModel.fromJson(e)).toList());
  }
}
